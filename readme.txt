...
* Provide temporary patch for WordPress 4.2.3 which broke backward compatibility with shortcodes inside HTML attributes. Specifically, the patch comments out line 209 in *wp-includes/shortcodes.php*. Use at own risk; backup recommended. It may not work depending on server permissions. It can also be done manually, for example, via FTP.
